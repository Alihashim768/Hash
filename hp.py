...
# Time Succes decompile : 2022-06-05 18:07:52.841433
...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;94m ALI ALWAYS BRAND \n\x1b[1;93mTABAHA\n\x1b[1;95mALONE\n\x1b[1;94mJALTY RAHO JALTA RAHONGA\n\x1b[1;96mUSER IS DIE\n\x1b[1;94mTUM NE US WAQT CHORA THA JIS WAQT MERA KOI NHE THA\n\x1b[32;1m=========================================\n \x1b[37;1m[\x1b[41;1m STATUS PAID TOOL RS_200PK\x1b[00;1m\x1b[37;1m ]\n\n \x1b[32;1m=========================================\n \x1b[32;1mCreator \x1b[37;1m: \x1b[33;1mALIBRAND\x1b\n \x1b[32;1mVersion \x1b[37;1m: \x1b[33;1m1.2\n \x1b[32;1m=========================================\n'
...
def reg():
    ...
    r = requests.get("https://pastebin.com/raw/gL0egEPn").text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+48699525511')
        reg()
...
def log_menu():
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m ~~~~ ALI BRAND ~~~~\x1b[1;91m'
        print 47 * '-'
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80ALI-BRAND\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80ALI-BRAND\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80ALI-BRAND\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mThanks To My Mind ALI-BRAND\x1b[1;91m'
    print 47 * '-'
